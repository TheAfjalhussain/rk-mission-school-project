...
const testimonials = [
  { name: "Sunita Devi", role: "Mother of Rahul, Class V", content: "R.K. Mission School has transformed my son's confidence. The teachers are very dedicated and the environment is safe and supportive. We are very happy with our choice.", rating: 5, avatar: "SD" },
  ...
  return (
    <section className="py-20 bg-cream overflow-hidden">
      <div className="section-container">
        <AnimatedSection>
          <SectionHeading badge="Testimonials" title="What Parents Say About Us" subtitle="Real stories from families who trust R.K. Mission School." />
        </AnimatedSection>
