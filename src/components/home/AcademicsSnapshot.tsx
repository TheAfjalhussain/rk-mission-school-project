...
const levels = [
  { icon: Baby, title: "Play & Nursery", classes: "Play – KG", description: "Play-based learning, motor skills, and social development in a joyful environment.", color: "bg-primary-light border-primary/20", iconColor: "text-primary-dark" },
  { icon: Sparkles, title: "Primary", classes: "Class I – V", description: "Strong fundamentals in language, maths, science, and values-based education.", color: "bg-secondary-light border-secondary/20", iconColor: "text-secondary" },
  { icon: BookOpen, title: "Middle School", classes: "Class VI – VIII", description: "Advanced CBSE curriculum with science labs, co-curriculars, and critical thinking.", color: "bg-accent-light border-accent/20", iconColor: "text-accent" },
  { icon: GraduationCap, title: "High School", classes: "Class IX – X", description: "Focused board exam preparation, career guidance, and holistic development.", color: "bg-sky-light border-sky/20", iconColor: "text-sky" },
];
