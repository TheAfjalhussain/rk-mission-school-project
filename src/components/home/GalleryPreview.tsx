...
const galleryImages = [
  { src: classroomImage, alt: "Classroom session at R.K. Mission School", category: "Classroom" },
  ...
  return (
    <section className="py-20 bg-background">
      <div className="section-container">
        <AnimatedSection>
          <SectionHeading badge="Gallery" title="Glimpses of School Life" subtitle="See the vibrant world of R.K. Mission School through our collection of memories." />
        </AnimatedSection>
