...
const faqs = [
  { q: "What curriculum does R.K. Mission School follow?", a: "We follow the CBSE curriculum with NCERT pattern, ensuring a nationally recognized and comprehensive education from Play to Class X." },
