...
const activities = [
  ...
  { icon: Bike, title: "Sports", description: "Cricket, athletics, and physical fitness.", color: "bg-sky-light text-sky" },
  ...
  return (
    <section className="py-20 bg-gradient-cool">
      <div className="section-container">
        <AnimatedSection>
          <SectionHeading badge="Activities" title="Beyond the Classroom" subtitle="A rich mix of co-curricular activities to develop every child's talents and confidence." />
        </AnimatedSection>
