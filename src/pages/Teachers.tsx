  ...
  return (
    <Layout>
        ...
        <div className="section-container relative">
          <AnimatedSection className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              Experienced, qualified, and passionate educators committed to shaping young minds at R.K. Mission School.
            </p>
          </AnimatedSection>
        </div>
      </section>
      ...
      <section className="py-20 bg-cream">
        <div className="section-container">
          <AnimatedSection><SectionHeading badge="Faculty" title="Our Expert Educators" subtitle="Get to know the dedicated professionals behind R.K. Mission School." /></AnimatedSection>
                ...
                <motion.div whileHover={{ y: -8 }} className="bg-card rounded-3xl overflow-hidden shadow-card hover:shadow-card-hover transition-all duration-300">
                  ...
                  <div className="p-6">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2"><GraduationCap className="h-4 w-4 text-secondary" /><span className="text-sm text-muted-foreground">{t.qualification}</span></div>
                      <div className="flex items-center gap-2"><Award className="h-4 w-4 text-primary" /><span className="text-sm text-muted-foreground">{t.experience}</span></div>
                    </div>
                  </div>
                </motion.div>
              </StaggerItem>
      ...
      <section className="py-20 bg-background">
        <div className="section-container">
          <AnimatedSection className="text-center max-w-3xl mx-auto">
            <span className="inline-block px-4 py-1.5 bg-lavender-light text-lavender rounded-full text-sm font-semibold mb-4">Join Us</span>
            <h2 className="font-heading text-3xl md:text-4xl font-bold text-foreground mb-4">Want to Be Part of Our Team?</h2>
            <p className="text-muted-foreground leading-relaxed mb-8">
              We're looking for passionate educators who share our vision. If you have a heart for teaching, we'd love to hear from you.
            </p>
            <motion.a href="/contact" whileHover={{ scale: 1.02 }} className="inline-flex items-center px-8 py-4 bg-primary text-primary-foreground rounded-full font-semibold shadow-soft hover:shadow-medium transition-all">
              Get in Touch
            </motion.a>
          </AnimatedSection>
        </div>
