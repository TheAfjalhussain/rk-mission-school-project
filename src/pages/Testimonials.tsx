...
const testimonials = [
  { name: "Sunita Devi", role: "Mother of Rahul, Class V", content: "R.K. Mission School has transformed my son's confidence and academics. The teachers are dedicated and the campus is safe. Best school in Nawada.", rating: 5, avatar: "SD" },
  ...
  return (
    <Layout>
      <section className="relative py-24 bg-gradient-warm overflow-hidden">
        <div className="section-container relative">
          <AnimatedSection className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">Real stories from families who trust R.K. Mission School with their children's future.</p>
          </AnimatedSection>
        </div>
      </section>
      ...
      <section className="py-20 bg-cream overflow-hidden">
        <div className="section-container">
          <AnimatedSection><SectionHeading badge="Featured" title="Parent Stories" subtitle="Hear directly from families who chose R.K. Mission School." /></AnimatedSection>
