...
const faqCategories = [
  ...
  },
  {
    title: "Academics",
    items: [
      { q: "Which board does the school follow?", a: "R.K. Mission School follows the CBSE curriculum with NCERT pattern for all classes from Play to X." },
      ...
      <section className="relative py-24 bg-gradient-cool overflow-hidden">
        <div className="section-container relative">
          <AnimatedSection className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">Find answers to common questions parents ask about R.K. Mission School.</p>
          </AnimatedSection>
        </div>
      </section>
