...
const blogPosts = [
  ...
  { title: "Republic Day Celebration at R.K. Mission School", excerpt: "Students performed patriotic songs, dances, and speeches marking a proud Republic Day celebration.", date: "Jan 26, 2025", category: "School News", slug: "#" },
];
      ...
      <section className="relative py-24 bg-gradient-warm overflow-hidden">
        <div className="section-container relative">
          <AnimatedSection className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">Parenting tips, school updates, and educational insights from R.K. Mission School.</p>
          </AnimatedSection>
        </div>
      </section>
